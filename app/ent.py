...
def agora06(username, password):
    ...
    # ENT / PRONOTE required URLs
    # amended for Florian
    identity_provider = "https://cas.agora06.fr/login?service=https://0061670h.index-education.net/pronote/eleve.html"
...
#    print('PAYLOAD', payload)
    ...
    log.debug('[ENT Eaux claires] Logging in with ' + username)
    response = session.post(identity_provider, data=payload, headers=headers)
#    print('------------')
#    print('Rsponse2: ',response.text)
...
def atrium_sud(username, password):
    ...
    """
    # ENT / PRONOTE required URLs
    ent_login = 'https://www.atrium-sud.fr/connexion/login?service=https:%2F%2F0061642c.index-education.net%2Fpronote%2F'
    print('ent: ', ent_login)
